    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-warning">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link text-white" href="#">Проекты <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Добавление времени</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Время" id="newProjName" name="newProjName">
                        </div>
                    </div>
...
<form>
    <div class="row pt-2">
        <div class="container">
            <table id="allproj" class="table table-striped sortable align-middle table-responsive-md btn-table mt-7">
                <thead class="thead-warning">
                <tr>
                    <th scope="col" onclick="sortTable(0)">#</th>
                    <th scope="col">Проект</th>
                    <th scope="col" onclick="sortTable(2)">Статус</th>
                </tr>
                </thead>
                <tbody>
                <%
                ...
                <tr class="table-row">
                    <td scope="col"><%= i + 1%></td>
                    <td scope="col">
                        <a href="ident.jsp" class="btn btn-link" onClick="addProjName(this.id)" id=<%= rs.getString("name")%>>
                            <%= rs.getString("name")%>
                        </a>
                    </td>

                    <td scope="col"><%= rs.getString("status")%></td>
                </tr>
                <%
                        ++i;}
                %>
